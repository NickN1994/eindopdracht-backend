...
-- INSERT INTO users (name, username, password, email, enabled) VALUES ('user', 'user', '$2a$12$IzA1Ja1LH4PSMoro9PeITO1etDlknPjSX1nLusgt1vi9c1uaEXdEK','user@test.nl', TRUE);
-- INSERT INTO users (name, username, password, email, enabled) VALUES ('admin', 'admin', '$2a$12$IzA1Ja1LH4PSMoro9PeITO1etDlknPjSX1nLusgt1vi9c1uaEXdEK', 'admin@test.nl', TRUE);
